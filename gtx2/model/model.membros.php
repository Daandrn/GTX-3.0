...
$consulta = connection()->prepare("SELECT pessoa.nome as nome, pessoa.nick as nick, statusmembro.descricao as cargo, canalstream.nickstream as nickstream, plataformastream.descricao as plataforma, canalstream.link_canal  
                                    FROM pessoa 
